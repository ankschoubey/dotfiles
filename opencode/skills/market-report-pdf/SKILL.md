...
The `/Users/ankushchoubey/.config/opencode/skills/market/scripts/generate_pdf_report.py` script expects a JSON file as input with this exact structure:
