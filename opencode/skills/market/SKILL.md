...
|---------|-------------|--------|
| `/market audit <url>` | Full marketing audit (5 analysis dimensions) | MARKETING-AUDIT.md |
...
This is the flagship command. It performs **5 sequential analyses** to analyze the website comprehensively:

1. **Content & Messaging** analysis → Content quality, messaging, copy effectiveness
2. **Conversion Optimization** analysis → CRO, funnels, landing pages, signup flows
3. **Competitive Positioning** analysis → Competitive positioning, market landscape
4. **Technical SEO** analysis → Technical SEO, site architecture, page speed
5. **Strategy** analysis → Overall strategy, pricing, growth opportunities
...
Fast 60-second assessment. Instead of full audit:
...
- `/market audit` performs all analyses → produces comprehensive analysis
